...
int my_strcmp(const char * s1, const char * s2, int sc1, int sc2);
int my_strcmp_bf(const char * s1, const char * s2, int sc1, int sc2);
int my_strcmp_f(const char * s1, const char * s2);
...
int my_strcmp(const char * s1, const char * s2, int sc1, int sc2) { // сравнение с -f
...
int my_strcmp_bf(const char * s1, const char * s2, int sc1, int sc2) { // сравнение с -b -f 
...
int my_strcmp_f(const char * s1, const char * s2) { // сравнение с -f
